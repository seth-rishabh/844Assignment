...
accuracy_cv = cross_val_score(myBernoulli, X, y, cv=10, scoring='accuracy')
f1_cv = cross_val_score(myBernoulli, X, y, cv=10, scoring='f1_weighted')
precision_cv = cross_val_score(myBernoulli, X, y, cv=10, scoring='precision_weighted')
recall_cv = cross_val_score(myBernoulli, X, y, cv=10, scoring='recall_weighted')
